...
<html lang="en">
  <head>
    ...
    <title>Selección tipo cargue</title>
...
<div class="container center">
    <div class="row-12">
        <label class="COMUNES1textobienvenida4" for="">La fotos de sus documentos como Cedula, Licencia de conducción y SOAT son necesarias para crear su cuenta, seleccione la mejor opción para usted:</label>
      </div>
</div>
  ...
  <div class="container">
    <div class="row">
          <div class="col-xs-2 col-sm-6 col-md-6">
              <button type="button" class="ESTILOS2botones1" name="fotoscelular">TOMAR LAS FOTOS CON EL CELULAR</button>
          </div>
          <div class="col-xs-2 col-sm-6 col-md-6">
              <button type="button" class="ESTILOS2botones2" name="fotoscomputadora">SUBIR LAS FOTOS DESDE LA COMPUTADORA</button>
          </div>
    </div>
  </div>

...
<div class="container">
  <br>
      <div class="form-group">
        ...
        <label class="COMUNES1textobienvenida1" for=""><b>Necesito Transporte</b></label><br>
        <br>

        <label class="COMUNES1textobienvenida2" for=""><b>Donde desea que se le entregue el producto</b></label><br>
        </div>
</div>
...
<form class="" action="index.html" method="post">
 ...
 <div class="row">
      <div class="col">
        <div class="ESTILOS1lineabajacampotexto">
          <input class="form-control" type="text" name=nombre placeholder="Escriba la direccion">
        </div>
      </div>
      </div>

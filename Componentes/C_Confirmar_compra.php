...
<div class="container center">
    <div class="row">
        <label class="COMUNES1textobienvenida4" for="">Ha comprado XXXXXX kg de XXXXXXX y XXXXX kg de XXXXXX por: $XXXXXX</label>
      </div>
</div>
  ...
  <div class="container">
    <div class="row">
          <div class="col-xs-2 col-sm-6 col-md-6" >
              <button type="button" class="ESTILOS2botones5" name="yatengocuenta">NECESITO TRANSPORTE</button>
          </div>
          <div class="col-xs-2 col-sm-6 col-md-6">
              <button type="button" class="ESTILOS2botones6" name="quierocrearcuenta">VOY A RECOGER MI PRODUCTO</button>
          </div>
    </div>
  </div>
